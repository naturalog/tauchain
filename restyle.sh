...
#2.5:
	astyle --style=attach --indent=tab --attach-namespaces --attach-classes --attach-inlines --indent-switches  --indent-cases --indent-preproc-cond --indent-col1-comments --pad-paren --pad-header --remove-brackets --close-templates --remove-comment-prefix --pad-oper --recursive "$path"
done
