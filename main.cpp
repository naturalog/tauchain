...
#include "JsonLdApi.h"
#include "Context.cpp"
	void RemoteDocument::setDocument ( const Object& document_ ) { document = document_; }
	...
	const Object& DocumentLoader::fromURL ( String url ) {
		...
		JsonLdOptions::JsonLdOptions ( String base = "" ) : expandContext(null) { setBase ( base ); }
	void JsonLdOptions::setExpandContext ( const Object& expandContext_ ) { expandContext = expandContext_; } 
