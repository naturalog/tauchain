Object Context::compactValue ( String activeProperty, Map<String, Object> value ) {
	// 1)
...
*/
Context Context::parse ( Object localContext, List<String> remoteContexts )  {
...
void Context::createTermDefinition ( Map<String, Object> context, String term,
...
/**
    ...
    @
*/
String Context::expandIri ( String value, boolean relative, boolean vocab, Map<String, Object> context,
                            Map<String, Boolean> defined )  {
	// 1)
...
*/
String Context::compactIri ( String iri, Object value, boolean relativeToVocab, boolean reverse ) {
	// 1)
	if ( iri == null )
		return null;
...
*/
Map<String, String> Context::getPrefixes ( boolean onlyCommonPrefixes ) {
...
*/
Map<String, Object> Context::getInverse() {
...
*/
String Context::selectTerm ( String iri, List<String> containers, String typeLanguage,
...
*/
Object Context::expandValue ( String activeProperty, Object value )  {
...
Map<String, Object> serialize() {
	...
	if ( get ( "@base" ) != null && !get ( "@base" ).equals ( options.getBase() ) )
		ctx.put ( "@base", get ( "@base" ) );
	if ( get ( "@language" ) != null )
		ctx.put ( "@language", get ( "@language" ) );
	if ( get ( "@vocab" ) != null )
		ctx.put ( "@vocab", get ( "@vocab" ) );
	for ( const String term : termDefinitions.keySet() ) {
