CXX=clang++
###NEW= -DNEW
ASAN=   -stdlib=libc++  -Xclang -fcolor-diagnostics -ferror-limit=10 -fsanitize=address -fsanitize=integer -fsanitize=unsigned-integer-overflow -fsanitize=undefined  # -fsanitize-undefined-trap-on-error 
