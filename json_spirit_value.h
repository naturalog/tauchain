...
public:
	...
	inline boost::int64_t     get_int64()  const;
	inline boost::uint64_t    get_uint64() const;
	inline double             get_real()   const;
	inline Object& get_obj();
	...
	inline boost::int64_t     Int()  const {
		return get_int64();
	}
	inline boost::uint64_t    uInt() const {
		return get_uint64();
	}
...
struct Config_map {
	...
	typedef std::vector<Value_type> Array_type;
	typedef map_t<String_type, Value_type> Object_type;
